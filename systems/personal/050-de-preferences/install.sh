...
if [ "$AR_OS" == "linux_archlinux" ]; then
    ...
    gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/ff58ebb6-357c-475a-bbc7-ef300f8ba4b4/ apps "['discord.desktop', 'discord-ptb.desktop', 'discord-canary.desktop', 'discord-development.desktop', 'pidgin.desktop', 'telegramdesktop.desktop', 'mumble.desktop', 'quassel.desktop']"
